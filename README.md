	...
	- ### Example (Clean Architecture)
		-
		  ...
		  ```
			...
			- *By putting the code for these methods into a single Employee class, the actors are coupled together. The actions of the CFO could affect those of the COO or CTO.*[^1]
